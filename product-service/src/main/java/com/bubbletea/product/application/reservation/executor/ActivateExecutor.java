...
public class ActivateExecutor implements ReservationCommandExecutor {
    ...
    public ReservationCommandType supports() {
        return ReservationCommandType.ACTIVATE;
    }
    ...
    public void execute(ProductChangeReservation reservation) {
        ...
        productChangeHistoryRepository.save(ProductChangeHistory.recordSuccess(
